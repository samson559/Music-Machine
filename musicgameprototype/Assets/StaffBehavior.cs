...
public class StaffBehavior : MonoBehaviour {
	...
	private RectTransform phTransform;
	...
	void Start () {
		...
		playing = true;
		speed = 0f;
		staffTransform = staff.GetComponent<RectTransform>() as RectTransform;
		phTransform = playhead.GetComponent<RectTransform>() as RectTransform;
	}
